                    ...
                    <div class="coluna col8">
                        <nav>
                            <ul class="menu inline sem-marcador">
                                ...
                                <li><a href="listar_historico.jsp">Histórico &raquo;</a></li>
                                <li><a href="pendencia.jsp">Pendência &raquo;</a></li>
            ...
            <section>
                ...
                <div class="coluna col7 contato">
                    ...
                    <form action="Editar_Historico_Servlet" method="post"> 
                        ...
                        <input name="data_inicio" placeholder="xxxx-xx-xx" style="width:150px;" value="<%= historico.data_inicio%>">
                        <!-- <label>(Ano-Mês-Dia)</label> -->
                        <br>
                        <label>Data de Conlusão do Serviço:</label>
                        <input name="data_termino" placeholder="xxxx-xx-xx" style="width:150px;" value="<%= historico.data_termino%>">
                         <!--  <label>(Ano-Mês-Dia)</label> -->
                        <br>
